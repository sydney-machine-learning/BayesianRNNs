...
parser.add_argument('-s','--samples', help='Number of samples', default=4000, dest="samples",type=int)
...
def main():
	...
	# for j in [2]:
		...
		[pos_w, rmse_train, indiv_rmse_train, rmse_test, indiv_rmse_test , likelihood] = mcmc.sampler()
