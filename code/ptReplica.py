...
class ptReplica(multiprocessing.Process):
    ...
    def run(self):
        ...
        likelihood = likelihood/self.adapttemp

        print(likelihood, rmsetrain, ' is initial lhood * * *')
        ...
        for i in range(samples-1):  # Begin sampling --------------------------------------------------------------------------
            ...
            if u < mh_prob:
                ...
                # acc_train[i+1,] = 0
                # acc_test[i+1,] = 0
                print(i, num_accepted, langevin_count, 'RMSE Train: ',rmsetrain,"RMSE Test: ", rmsetest,' accepted', likelihood_proposal, prior_current )
